    ...
    image: function()
    {
      return {
        ...
        showEdit: function($image)
        {
          ...
          if ($image.hasClass('lightbox-img')) $('#redactor-image-link-lightbox-img').prop('checked', true);
        ...
        update: function($image)
        {
          ...
          var $link = $image.closest('a');
          var target_2 = ($('#redactor-image-link-lightbox-img').prop('checked')) ? true : false;
          if (target_2) {
            $image.addClass('lightbox-img');
          } else {
            $image.removeClass('lightbox-img');
          }
        ...
        loadTemplates: function()
        {
          this.opts.modal = {
            ...
            + '<section id="redactor-modal-image-edit">'
              ...
              + '<label class="redactor-image-link-option"><input type="checkbox" id="redactor-image-link-lightbox-img">Afficher en Lightbox ?</label>'
